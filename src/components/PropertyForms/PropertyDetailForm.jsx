  ...
  return (
    <form className={classes["add-form"]} onSubmit={addPropertyDetailHandler}>
      <section className={classes["form-controls"]}>
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="no_of_bhk">
            No of BHK<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="no_of_bhk"
            id="no_of_bhk"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="number_of_floor">
            Number of Floor<span className={classes.asterisk}>*</span>
          </label>
          <select
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="attached">
            Attached<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="attached"
            id="attached"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="western_toilet">
            Western Toilet<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="western_toilet"
            id="western_toilet"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="furnished">
            Furnished<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="furnished"
            id="furnished"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="car_parking">
            Car Parking<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="car_parking"
            id="car_parking"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="lift">
            Lift<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="lift"
            id="lift"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="electricity">
            Electricity<span className={classes.asterisk}>*</span>
          </label>
          <input
            type="text"
            name="electricity"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="facing">
            Facing<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="facing"
            id="facing"
