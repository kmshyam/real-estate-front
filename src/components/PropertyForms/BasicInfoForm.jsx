      ...
      <section className={classes["form-controls"]}>
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="negotiable">
            Negotiable<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="negotiable"
            id="negotiable"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="ownership">
            Ownership<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="ownership"
            id="ownership"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="property_age">
            Property Age<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="property_age"
            id="property_age"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="property_approved">
            Property Approved<span className={classes.asterisk}>*</span>
          </label>
          <select
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="property_description">
            Property Description<span className={classes.asterisk}>*</span>
          </label>
          <input
            type="text"
        ...
        <div className={classes["form-control"]}>
          <label htmlFor="bank_loan">
            Bank Loan<span className={classes.asterisk}>*</span>
          </label>
          <select
            name="bank_loan"
            id="bank_loan"
